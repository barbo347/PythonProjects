...
def load_data(nrows):
    ...
    data["injured_pedestrians"] = data["number of pedestrians injured"]
    data["injured_cyclists"] = data["number of cyclist injured"]
    data["injured_motorists"] = data["number of motorist injured"]
...
if select == "Pedestrians":
    st.write(
        original_data.query("injured_pedestrians >= 1")[
            ["on street name", "injured_pedestrians"]
        ]
    ...
    st.write(
        original_data.query("injured_cyclists >= 1")[
            ["on street name", "injured_cyclists"]
        ]
    ...
    st.write(
        original_data.query("injured_motorists>= 1")[
            ["on street name", "injured_motorists"]
        ]
